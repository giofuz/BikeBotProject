module.exports = {
    ...
    var WTF = (function() {
        ...
        */
        ...
        function generate() {
            ...
            // Contains the random sentence with heading and template, which is then returned
            var ex = randomItem(headings) + ", " + idea;
            return ex;
    ...
    WTF.init({
        ...
        "response": [
            "Already fecking seen one",
            "Give me a-feckking-nother one",
            "Don't really give a feck"
        ],

        "template": [
            "I was @verb in the @noun",
            "I am a @bot that is @service @ex"
        ],
